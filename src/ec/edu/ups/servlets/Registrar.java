...
public class Registrar extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println( cedula + " " + placaVehiculo + " " + marcaVehiculo + " " + modeloVehiculo + " " + numeroTicket + " " +  fechaEntrada + " " + horaEntrada + " " + fechaSalida + " "  + horaSalida  );
		...
		if (cliente == null) {
			...
			Ticket ticket = new Ticket(Integer.valueOf(numeroTicket), fechaEntrada, fechaSalida, horaEntrada, horaSalida, vehiculo);
			...
			response.sendRedirect("/CorreccionExamen/jsp/listar.jsp");
		}
